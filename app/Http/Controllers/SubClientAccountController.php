...
class SubClientAccountController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $query = SubClient::with(['type', 'facilities.facility', 'departments.department', 'filters', 'dynamicFields','minDurations'])->where('status',1);
    ...
    public function page(Request $request)
    {
        try {
            ...
            $query = SubClient::with(['type', 'facilities.facility', 'departments.department', 'filters', 'dynamicFields','minDurations.language']);
            $search = $request->get('search', '');
            $sortBy = $request->get('sortBy', 'created_at');
            $pageLength = $request->get('pageLength', 10);
            $sortDirection = $request->get('sortDirection', $sortBy === 'created_at' ? 'desc' : 'asc');
    ...
    public function store(Request $request)
    {
        ...
        try {
            $record = SubClient::create([
                ...
                'est_duration'=>$request->est_duration,
            ]);
