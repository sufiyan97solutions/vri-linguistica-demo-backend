...
class AppointmentController extends Controller
{
    ...
    public function get($id)
    {
        try {
            ...
            $record = Appointment::with(['accounts.user', 'language', 'interpreter.user', 'vendor', 'appointmentDetails.facility', 'appointmentDetails.department','appointmentDetails.patient', 'appointmentAssign'])->find($id);
            if (!$record) {
        ...
        try {
            ...
            foreach ($changes as $field => $newValue) {
                ...
                if ($field == 'subclient_id') {
                    ...
                    $log_changes .= "\nField 'facility' changed from '" . Facility::find($oldValue)?->abbreviation . "' to '" . Facility::find($newValue)?->abbreviation . "'";
                } else if ($field == 'department_id') {
                    $log_changes .= "\nField 'department' changed from '" . Department::find($oldValue)?->name . "' to '" . Department::find($newValue)?->name . "'";
